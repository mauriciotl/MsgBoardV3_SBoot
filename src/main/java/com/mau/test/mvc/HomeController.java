...
public class HomeController {
    ...
    public View home(Model model) {
        logger.info("Processing request for home page");
        String dashboardUrl = "dashboard"; // This could be dynamically determined
        model.addAttribute("dashboardUrl", dashboardUrl);
        return new RedirectView("/mvc/" + dashboardUrl, true);
    }

    @RequestMapping(value = "/mvc/{dashboardUrl}", method = RequestMethod.GET)
    public String dashboard(@PathVariable String dashboardUrl, Model model) {
        logger.info("Processing request for dashboard: {}", dashboardUrl);
